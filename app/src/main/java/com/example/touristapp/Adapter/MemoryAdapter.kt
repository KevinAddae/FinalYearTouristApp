...
class MemoryAdapter(val context: Context, val memory: List<Memories>,
                    val onClickListener: OnClickListener,
                    val onItemLongClickListener: OnItemLongClickListener) : RecyclerView.Adapter<MemoryAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.memories_singleitem, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val location = holder.itemView.findViewById<TextView>(R.id.memories_singleItem_Location)
        val image = holder.itemView.findViewById<ImageView>(R.id.memories_singleItem_Image)
